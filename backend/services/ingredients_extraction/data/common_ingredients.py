...
FOOD_INGREDIENTS: Set[str] = {
    ...
    "olein", "stearin", "margarine", "tallow", "ghee",
    "unsalted butter", "salted butter", "clarified butter", "butter oil",
    "cocoa butter", "shea butter", "mango butter",
    
    # === DAIRY ===
    "whole milk", "skim milk", "low fat milk", "fat free milk",
    ...
    "heavy cream", "light cream", "whipping cream", "sour cream", "double cream", "single cream",
    ...
    "yogurt", "yoghurt", "greek yogurt", "greek yoghurt", "plain yogurt", "yogurt powder",
    ...
    "whey powder", "whey protein", "whey protein concentrate",
    "whey protein isolate", "sweet whey", "acid whey",
    "casein", "caseinate", "sodium caseinate", "calcium caseinate", "milk protein",
    "milk fat", "anhydrous milk fat", "milk solids not fat",
    "gluten free",
    
    # === EGGS ===
    "whole egg", "egg white", "egg yolk", "egg powder",
    ...
    # === SOY & LEGUMES ===
    "soya", "soybeans", "soy protein", "soy protein isolate",
    "isolated soy protein", "isolated soya protein",
    "soya protein isolate", "soya protein",
    "soy protein concentrate", "textured soy protein", "hydrolyzed soy protein",
    "soy flour", "soy lecithin", "soya lecithin",
    ...
    # === STARCHES & THICKENERS ===
    "corn starch", "cornstarch", "potato starch", "tapioca starch",
    ...
    "glucose syrup", "glucose solids", "liquid glucose",
    "dextrose monohydrate",
    "crystalline fructose", "high fructose corn syrup", "hfcs",
    "corn syrup", "corn syrup solids", "maltose", "malt syrup",
    "raw honey", "pasteurized honey", "honey powder",
    "maple", "maple syrup", "maple sugar", "agave", "agave syrup", "agave nectar",
    ...
    "natural flavouring", "natural flavourings",
    "artificial flavor", "artificial flavoring", "artificial flavors",
    "flavor", "flavoring", "essence",
    ...
    "mustard seed", "mustard powder", "dry mustard",
    "thyme", "rosemary", "sage", "marjoram",
    "cilantro", "dill", "dill weed", "tarragon", "chervil",
    ...
    # === ALLIUMS ===
    "garlic powder", "garlic salt", "granulated garlic", "garlic flakes",
    "onion powder", "onion salt", "dried onion", "onion flakes", "onions",
    "shallot", "leek", "chive", "chives", "scallion", "green onion", "spring onion",
    
    # === VEGETABLES ===
    "tomatoes", "tomato paste", "tomato puree", "tomato pureed", "tomato sauce",
    "tomato powder", "sun dried tomato", "diced tomato", "crushed tomato",
    "carrot", "carrot powder", "carrot juice",
    ...
    "green peas", "split peas", "pea protein",
    "sweet corn", "corn kernel", "baby corn", "corn cob",
    ...
    "oranges", "orange juice", "orange peel", "orange zest",
    "lemons", "lemon juice", "lemon peel", "lemon zest",
    "lime", "limes", "lime juice", "lime peel", "lime zest",
    "grapefruit", "grapefruit juice", "tangerine", "mandarin", "clementine",
    "grape", "grapes", "grape juice", "raisin", "raisins", "sultana", "sultanas", "currant",
    ...
    # === VINEGAR & ACIDS ===
    "white vinegar", "distilled vinegar", "wine vinegar",
    ...
    # === NUTS & SEEDS ===
    "almond", "almond flour", "almond meal", "almond butter",
    "californian almonds", "californian",
    "almond milk", "almond extract", "marzipan", "almond paste",
    "peanut", "roasted peanuts", "peanut butter", "peanut oil", "peanut flour",
    ...
    "pecan", "pecans", "macadamia", "brazil nut", "brazil nuts", "brazil",
    "chestnut", "chestnuts", "chestnut flour",
    "pine nut", "pine nuts", "coconut",
    "sesame seed", "sesame seeds", "sesame oil", "tahini",
    "sunflower seed", "sunflower seeds", "sunflower butter",
    "pumpkin seed", "pumpkin seeds", "pepitas",
    "flaxseed", "flax seed", "flax seeds", "flax", "linseed", "flaxseed meal",
    "chia seed", "chia seeds", "chia",
    "hemp seed", "hemp seeds", "hemp hearts",
    "poppy seed", "poppy seeds",
    "nut", "mixed nuts", "tree nuts", "nut butter",
    
    # === GRAINS & CEREALS ===
    "whole wheat", "wheat flour", "atta", "maida", "refined wheat flour",
    ...
    "oat", "oats", "rolled oats", "steel cut oats", "instant oats", "oat flour", "oats flour",
    "oat fiber", "oat bran", "oatmeal", "oat flakes", "oat milk",
    "white rice", "brown rice", "jasmine rice", "basmati rice",
    "wild rice", "rice bran", "rice protein",
    "pearl barley", "barley flour", "barley malt", "barley flakes",
    "rye", "rye flour", "rye bread", "pumpernickel",
    "maize", "maize flour", "maize starch",
    ...
    # === MEAT & POULTRY ===
    "chicken meat", "chicken breast", "chicken thigh", "chicken wing",
    "chicken stock", "chicken broth", "chicken fat", "chicken powder",
    "ground beef", "beef stock", "beef broth", "beef fat",
    "bacon", "ham", "pork fat", "pork rinds",
    ...
    "gelatine", "collagen", "bone broth",
    
    # === SEAFOOD ===
    "fish sauce", "fish oil", "fish stock", "fish powder",
    ...
    # === LEAVENING ===
    "active dry yeast", "instant yeast", "fresh yeast", "nutritional yeast",
    ...
    "carrageenan", "agar", "agar agar", "apple pectin", "citrus pectin", "pectins",
    ...
    # === MISCELLANEOUS ===
    "caramel color", "caramel coloring", "caramel syrup",
    "annatto extract", "paprika extract", "turmeric extract",
    ...
    "puffed rice", "puffed wheat", "crisped rice",
    "rice milk", "coconut flour",
    "fat", "kernel", "greek", "toned",
    "free range",
    
    # === DESCRIPTORS (for word-by-word correction) ===
    "powdered", "concentrate", "concentrated", "dried", "dehydrated",
    "fresh", "frozen", "canned", "preserved", "smoked", "cured",
    "organic", "conventional",
    "raw", "cooked", "roasted", "toasted", "baked", "fried",
    "ground", "chopped", "diced", "sliced", "minced", "pureed",
    "refined", "unrefined", "bleached", "unbleached", "enriched", "fortified",
    "pasteurized", "homogenized", "ultra pasteurized",
    "reconstituted", "modified", "carbonated", "sparkling",
    "salted", "unsalted", "malted", "puffed", "crisped", "crisp",
    "flaked", "rolled", "instant", "golden",
    "caramelised", "caramelized", "infused", "fermented", "cultured",
    "iodised", "iodized", "hydrogenated", "interesterified",
    "sweetened", "unsweetened", "skimmed", "defatted", "reduced", "low",
    "white", "red", "yellow", "green", "dark", "light",
    "sweet", "sour", "bitter", "savory", "salty", "spicy", "mild", "hot",
    "pieces", "slices", "flakes", "chips",

    # === BRITISH SPELLINGS (for word-by-word correction) ===
    "flavour", "flavours", "flavouring", "flavourings",
    "colour", "colours", "colouring", "colourings",
    "fibre", "fibres",
    "stabilisers", "thickeners",

    # === LABEL ROLE WORDS (functional terms on packaging) ===
    "permitted", "edible", "added", "contains", "free",
    "leavening", "glazing", "gelling", "firming", "thickening",
    "bulking", "foaming", "anticaking",
    "acidity", "regulator", "regulators",
    "agent", "improver", "conditioner",
    "texturizer", "texturiser",
    "humectant", "sequestrant",
} | set(VERY_COMMON_INGREDIENTS)
